    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            validationMsgs: {
                ...
                tasks: ['ngtemplates:angularResponsiveCarousel']
            },
            bower: {
                files: ['bower.json'],
            ...
            unitSingleRunDist: {
                ...
                options: {
                    files: [
                        ...
                        // endbower
                        '<%= appConfig.dist %>/angular-responsive-carousel.min.js',
        ...
        copy: {
            ...
            unminifiedJs: {
                files: [
                    ...
                    {
                        flatten: true,
                        src: ['.tmp/concat/angular-responsive-carousel.min.js'],
                        dest: '<%= appConfig.dist %>/angular-responsive-carousel.js'
                    }
                ]
            },
            ghPages: {
        ...
        bump: {
            options: {
                ...
                commitFiles: [
                    'package.json',
                    'bower.json',
                    'dist/angular-responsive-carousel.min.js',
                    'dist/angular-responsive-carousel.js'
                ],
                createTag: true,
                tagName: 'v%VERSION%',
                tagMessage: 'Version %VERSION%',
                push: true,
                pushTo: 'git@github.com:johannesjo/angular-responsive-carousel.git',
